...
def about(header=False):
    ...
    if header==False:
        ...
        if response == "e":
            print("    exiting.")
        if response == "h":
            print("    documentation can be accessed at https://insertlink.com.")
        print("")
        print("    #############################################################################################")
...
#creates the pixel array through interactive python window
...
#removes sections of the pixel array based on the pixel finder
...
def hotspot_primer(filepath, find):
    replace = (255,255,255)
...
#hotspot_calculator("/home/ravi14bandaru/GitHub/mednoise/images/*.png",200,25, (0,0,0))
#hotspot_analyzer(filepath = "/home/ravi14bandaru/GitHub/mednoise/images/*.png", x = 200,y = 25, find = (0,0,0), d = storeddictionary)
#hotspot_isolator(filepath = "/home/ravi14bandaru/GitHub/mednoise/images/*.png", x = 200,y = 25, find = (0,0,0), a = analyzedval)